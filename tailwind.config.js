...
export default {
    ...
    theme: {
        ...
        extend: {
            fontFamily: {
                'jiang-cheng': ['JiangChengJianRenHei', 'sans-serif'],
            },
            colors: {
            ...
            keyframes: {
                ...
                'pulse-glow': {
                    '0%, 100%': { boxShadow: '0 0 8px 2px hsla(44, 64%, 52%, 0.3)' },
                    '50%': { boxShadow: '0 0 20px 6px hsla(44, 64%, 52%, 0.6)' }
                },
                'marquee': {
            ...
            animation: {
                ...
                'constellation': 'constellation-pulse 3s ease-in-out infinite',
